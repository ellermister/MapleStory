...
function action(mode, type, selection) {
   ...
   status--;
	...
	text += " #r《该文件是Vr001 封测版服务端的核心文件之一》#k\r\n"
	text += "目前版权 (C) 2010年  #bVr001 封测版<159502199@qq.com>#k\r\n"; 
	text += "***************************************************\r\n";
	text += "之前人员 (C) 2008年   #bHuy<patrick.huy@frz.cc>#k\r\n";
	text += "                #bMatthias Butz<matze@odinms.de>#k\r\n";
	text += "         #bJan Christian Meyer <vimes@odinms.de>#k\r\n";
	text += "***************************************************\r\n";
	text += " @该服务端目前维护人员:#bVr001 封测版#k\r\n";
	text += " @这个文件是自由形式.你可以任意内容\r\n";
	text += " @这个程序发布的目的是期望它能有所用\r\n";
	text += " @如果你需要技术支持,可以联系更新/维护人员#dQQ100807851#k\r\n";
	text += " @你应该已经收到一份#bAffero GNU通用公共授权#k\r\n";
	text += " @如果不是,请仔细查看#bhttp://www.gnu.org/licenses/#k"
	text += " \r\n#L1#查看设置"
   cm.sendSimple(text);
    } else if (status == 1) {
           if (selection == 0) {      
