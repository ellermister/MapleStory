        ...
        if (status == 0) {
            ...
            if (beauty == 0) {
               if (cm.haveItem(4004004, selection*10)&&cm.haveItem(4001126, selection*10)){
                 ...
                 if (cm.haveItem(4005000, selection*5) && cm.getPlayer().getMeso() >selection*1000000){
					 cm.gainItem(4005000, -selection*5);
                 ...
                 if (cm.haveItem(4005002, selection*5) && cm.getPlayer().getMeso() >selection*1000000){
					 cm.gainItem(4005002, -selection*5);
					cm.gainMeso(-1000000* selection); //加减金币
                 ...
                 if (cm.haveItem(4005001, selection*5) && cm.getPlayer().getMeso() >selection*1000000){
					 cm.gainItem(4005001, -selection*5);
					cm.gainMeso(-1000000* selection); //加减金币
                 ...
                 if (cm.haveItem(4005003, selection*5) && cm.getPlayer().getMeso() >selection*1000000){
					 cm.gainItem(4005003, -selection*5);
					cm.gainMeso(-1000000* selection); //加减金币
                 ...
                 if (cm.haveItem(4005000, selection*1) &&cm.haveItem(4005001, selection*1) &&cm.haveItem(4005002, selection*1) &&cm.haveItem(4005003, selection*1) && cm.getPlayer().getMeso() >selection*10000000){
