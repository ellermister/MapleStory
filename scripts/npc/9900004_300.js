...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            //text += "#L4##e#d#v4031975#Lv77  黄金枫叶制造（天然+9回合）#l\r\n"//3
            //text += "#L5##e#d#v4031975#Lv100 扎昆泊伊兹尼#l\r\n"//3
            //text += "#L7##e#d#v4031975#Lv120 永恒武器制造#l\r\n"//3
            //text += "#L8##e#d#v4031975#Lv130 伽耶武器制造(强烈推荐平民玩家制作)#l\r\n"//3
            cm.sendSimple(text);
        } else if (selection == 1) {
		cm.openNpc(9900004, 401);
        } else if (selection == 2) {
		cm.openNpc(9900004, 402);
        } else if (selection == 3) {
		cm.openNpc(9900004, 403);
        } else if (selection == 4) {
		cm.openNpc(9900004, 404);
        } else if (selection == 5) {
		cm.openNpc(9000018, 405);
        } else if (selection == 6) {
		cm.openNpc(9000018, 406);
        } else if (selection == 7) {
		cm.openNpc(9000018, 407);
        } else if (selection == 8) {
		cm.openNpc(9900004, 408);
	}
    }
}
