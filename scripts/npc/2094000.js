	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if (cm.getParty() == null) { // No Party
				cm.sendOk("您想要挑战#b百级副本#k吗?那么您必须要有一个组队噢!\r\n·等级要求:100级-?级.\r\n·队伍要求:3~6人\r\n#k·任务奖励:#b未知.");
				cm.dispose();
				...
				cm.sendOk("如果想要挑战#b百级组队修炼#k请让你们的#b组队长#k来找我吧!.");
				cm.dispose();
			} else {
				...
				if (next) {
					var em = cm.warpParty(925100000);
cm.getMap(925100000).addMapTimer(900, 925100700);
		if (em == null) {
