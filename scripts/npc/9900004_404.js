...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		cm.openNpc(1002006, 31);
        } else if (selection == 2) {
		cm.openNpc(1002006, 32);
        } else if (selection == 3) {
		cm.openNpc(1002006, 33);
        } else if (selection == 4) {
		cm.openNpc(1002006, 34);
        } else if (selection == 5) {
		cm.openNpc(1002006, 35);
        } else if (selection == 6) {
		cm.openNpc(1002006, 36);
        } else if (selection == 7) {
		cm.openNpc(1002006, 37);
        } else if (selection == 8) {
		cm.openNpc(1002006, 38);
        } else if (selection == 9) {
		cm.openNpc(1002006, 39);
        } else if (selection == 10) {
		cm.openNpc(1002006, 310);
        } else if (selection == 11) {
		cm.openNpc(1002006, 311);
        } else if (selection == 12) {
		cm.openNpc(1002006, 312);
        } else if (selection == 13) {
		cm.openNpc(1002006, 313);
        } else if (selection == 14) {
		cm.openNpc(1002006, 314);
        } else if (selection == 15) {
		cm.openNpc(1002006, 315);
        } else if (selection == 16) {
		cm.openNpc(1002006, 316);
	}
    }
}
