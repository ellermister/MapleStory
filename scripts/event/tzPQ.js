...
function setup() {
	exitMap = em.getChannelServer().getMapFactory().getMap(922000009); // ³ö¿Ú
	var instanceName = "tzPQ" + instanceId;
	var eim = em.newInstance(instanceName);
	var mf = eim.getMapFactory();
	instanceId++;
	var map = mf.getMap(970030204);
	map.shuffleReactors();
	var firstPortal = eim.getMapInstance(970030204).getPortal("next00");
	firstPortal.setScriptName("tzpq1");
...
function playerEntry(eim, player) {
	var map = eim.getMapInstance(970030204);
