...
function setup() { 
 ...
 em.schedule("timeOut", 520 * 120);//到达制定地图后规定时间是2分钟。可以在此修改
...
function playerEntry(eim, player) { 
 ...
 player.getClient().getSession().write(net.sf.odinms.tools.MaplePacketCreator.serverNotice(5, "怪物强化了……"));  //进入地图后聊天窗内提示该语句
 startInstance(eim); 
} 
