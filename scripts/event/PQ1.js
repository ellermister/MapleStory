...
var instanceId; 
var minPlayers = 6;
var mapId = 970030103; //任务点
var qtmapId = 970030001; //领奖地点
...
function playerEntry(eim, player) { 
 ...
 player.getClient().getSession().write(net.sf.odinms.tools.MaplePacketCreator.serverNotice(5, "进入副本地图.有时间限制!请在规定时间内完成!")); 
 startInstance(eim); 
} 
