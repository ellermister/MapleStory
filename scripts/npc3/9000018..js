...
function action(mode, type, selection) {
   ...
   status--;
	...
	text += "尊敬的玩家.双倍吊坠火爆来临.佩戴即可获得#b 双倍经验 #k效果\r\n还在等什么？ 你，值得拥有！\r\n<双倍吊坠可重叠双倍卡效果>\r\n您账户目前剩点卷为：#r"+cm.getNX()+"#k"
	text += "\r\n#L2##b使用#r500个枫叶兑换500点卷#k\r\n"; 
	text += "\r\n#L1##r获取精灵吊坠<一天使用权>-3000点卷#k";
	text += "\r\n#L3##d获取精灵吊坠<七天使用权>-16666点卷#k";
        text += "\r\n#L4##b获取精灵吊坠<30天使用权>-88888点卷#k";
		   ...
		   cm.dispose();
			...
			if (cm.haveItem(4001126, 500)) { 
		   	cm.gainItem(4001126, -500);
            		cm.gainNX(1000);
			cm.sendOk("尊敬的玩家，你的账户已经成功增加了500点卷了！");
                  	cm.dispose();
                   	} else {
	           	cm.sendOk("尊敬的玩家，你的枫叶不足500个啊~！");
			cm.dispose(); }
    }else if  (selection == 4) {
           if ((cm.getNX() >= 88888)) { 
			cm.gainNX(-88888);
