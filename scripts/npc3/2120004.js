...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
				...
				var text = "#e你好,我的朋友:#r#h #.#k您累计充值:#r"+cm.getPlayer().getCSPoints(1)+"#k点券.#k\r\n";
				//var text = "#e你好,我的朋友:#r#h #.#k您累计充值:#r" + cm.getHyPay(3) + "#k点券.#k\r\n";
				//text += "#L11##fEffect/CharacterEff/1112905/0/1#进入自由市场↑#l";
				text += "#L8##fEffect/CharacterEff/1112905/0/1##b#e领取充值1000点券礼包#l\r\n";
				text += "#L1##fEffect/CharacterEff/1112905/0/1##b#e领取充值5000点券礼包#l\r\n";
				text += "#L2##fEffect/CharacterEff/1112905/0/1##b#e领取充值10000点券礼包#l\r\n";
				text += "#L3##fEffect/CharacterEff/1112905/0/1##b#e领取充值15000点券礼包#l\r\n";
				text += "#L4##fEffect/CharacterEff/1112905/0/1##b#e领取充值20000点券礼包#l\r\n";
