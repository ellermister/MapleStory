...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            gsjb += "#L13##b#v4000463#[#r货币#k]兑换[#r点卷#k]  #b比例 - (#r1 = 1000#b)#k#l\r\n";
			gsjb += "#L140##b#v4000463#[#r点卷#k]兑换[#r货币#k]  #b比例 - (#r1000 = 1#b)#k#l\r\n";
			gsjb += "#L1##r3货币购买混沌卷轴。#v2049100##z2049100# ×1#l\r\n"//3
			gsjb += "#L2##r3货币购买祝福卷轴。#v2340000##z2340000# ×1#l\r\n"//3
			...
			*/
            ...
            if (selection == 0) {
               ...
               if (cm.getPlayer().getCSPoints(1) < 200) {
                    ...
                    beauty = 8;
                    cm.sendGetNumber("请输入要兑换#v4170011# 的数量。\r\n当前点券: #r"+cm.getPlayer().getCSPoints(1)+"#k \r\n\r\n\r\n", 1, 1, 1000);
 ...
 cm.sendGetNumber("请输入兑换#r#z4000463##k的数量:\r\n#b比例 - (#r1500 = 1#b)\r\n你的点卷数量: #r" +cm.getPlayer().getCSPoints(1) + " \r\n", 1, 1, 100000 );
           ...
           if (beauty == 1) {
               if (cm.haveItem(4000463, selection*3)){
					//cm.setmoneyb(-selection*5);  //加减充值币
					 cm.gainItem(4000463, -selection*3);
                ...
                if (cm.getPlayer().getCSPoints(1) >= selection*200){
					cm.gainNX(-selection*200);	//加减点券
                     cm.sendNext("购买成功:[#r"+selection+"#k]个#v1470011#。#k");
					 cm.dispose();
                } else {
                    cm.sendNext("条件不足无法兑换。");
                    cm.dispose()
...
*/
				...
				var czb=cm.getmoneyb();
                 ...
                 if (cm.haveItem(4000463, selection)){
					 cm.gainItem(4000463, -selection);
                    cm.sendNext("兑换成功。 [#r"+selection+"#k] 货币兑换了:[#r"+(selection*1000)+"#k]个 点卷");
                    cm.gainNX(+1000 * selection);
					 cm.dispose();
                } else {
                    cm.sendNext("您的输入的数量错误，无法兑换。");
