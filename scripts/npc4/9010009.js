...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#e#d你好！这里是世纪冒险岛跑商送货中心:.\r\n跑商送货任务有9环，越到后面奖励越丰富.\r\n奖励顺序：超级药水x20.金猪x1.黄金枫叶x10.国庆纪念币x5.盛大易宝x1.法老蓝宝石x20.金杯x1.法老蓝宝石x80.混沌祝福x2.#l\r\n"//3
            text += "#L1##k#v4031149# 开始跑商送货.#n\r\n\r\n"//3
            text += "#L2##e#k#v4031017# 我想知道跑商的NPC都在哪些地方.#l\r\n\r\n"//3
