...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            cm.sendSimple("#e#d<组队任务：月妙组队任务>#n\r\n你想和队员们一起努力，完成任务吗，2人即可进入？副本通关需求20个年糕，其余的年糕要给组员拿出副本分享哦~！给队长会都被小虎收走哦！如果想挑战，请让#b所属组队的队长#k来和我说话。\r\n副本通关附送#v4310099#.#v4031191#点击[拍卖]-[副本奖励]进行换物/抽奖.\r\n#b#L0#我想执行组队任务。#l\r\n#L1#我想听一下说明。#l\r\n#L2##r50个年糕兑换一个#v1002798#4维属性+3.HP/MP+100.+1攻1魔.#l")
        } else if (status == 1) {
            if (selection == 0) {
			...
			cm.喇叭(2, "[" + cm.getPlayer().getName() + "]开始带领他的队伍挑战【月妙副本】，让我们祝福他们！！");	
				...
				if(cm.haveItem(4001101,50)){
					...
					cm.gainItem(1002798,3,3,3,3,100,100,1,1,10,10,0,0,0,0);
